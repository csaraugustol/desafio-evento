            ...
            <div class="container-fluid w-50" style="height: 550px;">
                ...
                <div class="login-section-wrapper">
                    ...
                    <div class="login-wrapper my-auto ">
                        <h1 class="login-title text-primary text-center">Cadastro</h1>
                        <form action="control" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <%  Usuario user = (Usuario) request.getAttribute("user") == null ? null : (Usuario) request.getAttribute("user");
                                    if (user != null) {%>
                                <input required type="text" name="nome" id="nome" class="form-control" value="<%=user.getNome()%>" placeholder="Digite seu nome..">
                                <%} else {%>    
                            ...
                            <br>
                            <input name="salvar" id="salvar" class="btn btn-block btn-outline-primary login-btn " type="submit" value="Cadastrar">

                        </form>
                        <br>
                        <p class="login-wrapper-footer-text text-center"><a href="control" class="text-reset text-primary">Voltar</a></p>
                    </div>
                </div>
