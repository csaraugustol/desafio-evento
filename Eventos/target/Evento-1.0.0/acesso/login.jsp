...
<html>
    ...
    <body class="bg-primary">
        <main class="container border shadow-lg p-3 mb-5 bg-body rounded mt-5 w-50 bg-warning">
                ...
                <div class="login-section-wrapper ">
                    ...
                    <div class="login-wrapper my-auto ">
                        ...
                        <form action="control" method="post">
                            ...
                            <input name="login" id="login" class="btn btn-block btn-outline-danger login-btn " type="submit" value="Login">
                        </form>
                        <br>
